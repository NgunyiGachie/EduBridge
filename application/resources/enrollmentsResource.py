...
class EnrollmnetByID(Resource):
    ...
    def get(self, id):
        ...
        """
        response_dict = Enrollment.query.filter_by(id=id).first()
    ...
    def patch(self, id):
        ...
        """
        record = Enrollment.query.filter_by(id=id).first()
        if not record:
    ...
    def delete(self, id):
        ...
        try:
            ...
            db.session.commit()
            response_dict = {"message": "Enrollment successfully deleted"}
