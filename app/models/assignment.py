...
class Assignment(db.Model):
    ...
    course = db.relationship('Course', back_populates='assignments', lazy="dynamic", cascade="all, delete-orphan")
    submissions = db.relationship('Submission', back_populates='assignments', lazy="dynamic", cascade="all, delete-orphan")
